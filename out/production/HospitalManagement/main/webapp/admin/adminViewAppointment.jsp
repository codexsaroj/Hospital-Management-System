...
<head>
	...
	<style>
        ...
        .backImg{
            background: linear-gradient(rgba(0,0,0,.4), rgba(0,0,0,.4)), url("../img/slider/hos2.jpg");
            height: 30vh;
            width:100%;
				...
				<div class="card-body">
					...
					<table class="table table-striped table-hover">
						...
						<%
							...
							List<Appointment> listAppointment = dao.displayAllAppointments();
						%>
						<%! int i = 1;%>
